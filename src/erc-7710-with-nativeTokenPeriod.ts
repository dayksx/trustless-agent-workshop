...
import { createCaveatEnforcerClient, createDelegation, Implementation, toMetaMaskSmartAccount } from "@metamask/smart-accounts-kit";
...
// Start date must be in the past: block.timestamp can lag behind wall clock.
// Starting 60s ago ensures the first period is active when we query availableAmount.
...
const execution = createExecution({
    ...
    value: parseEther("0.000000088"), // 0.01 ETH in wei
    callData: "0x",
});
